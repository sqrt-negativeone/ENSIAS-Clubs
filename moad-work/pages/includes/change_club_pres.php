...
<div class="row" style="margin-bottom: 40px;margin-top: 10px;">
    <div class="col" data-aos="zoom-in-up">
        <div class="card">
            <div class="card-body">
                <h4 style="font-size: 1.3rem;">Current club president:</h4>
                <div class="row justify-content-center">
                    ...
                    <div class="col-auto m-auto"><button class="btn btn-danger" type="button" data-toggle="modal" data-target="#presidentSelection">Change</button></div>
                </div>
            </div>
        </div>
    </div>
