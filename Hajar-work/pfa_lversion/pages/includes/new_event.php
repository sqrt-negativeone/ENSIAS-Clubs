<div class="row" data-aos="zoom-in-up" style="margin-bottom: 20px;">
    <div class="col" style="margin-top: 10px;">
        <div class="shadow card"><a class="btn btn-link text-left card-header font-weight-bold" data-toggle="collapse" aria-expanded="true" aria-controls="collapse-4" href="#collapse-4" role="button" style="margin-bottom: 10px;">CREATE EVENT</a>
                ...
                <form method="post" action="functions/create_event.php" enctype="multipart/form-data">
                    <div class="form-group">
                        <div class="form-row">
                            ...
                            <div class="col-auto"><input class="form-control" type="text" name="titre" required=""></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col-3" style="width: auto;"><label class="col-form-label" style="margin-left: 10%;">Photo&nbsp;</label></div>
                            <div class="col-auto col-sm-2"><input type="file" style="margin-top: 1%;" name="photo" required=""></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col-3" style="width: auto;"><label class="col-form-label" style="margin-left: 10%;">Type&nbsp;</label></div>
                            <div class="col-auto"><select class="form-control" name="type" required="">
                    ...
                    <div class="form-group">
                        <div class="form-row">
                            ...
                            <div class="col-4"><input class="form-control" type="datetime-local" name="date_deb" required=""></div>
                        </div>
                    </div>
                     <div class="form-group">
                        <div class="form-row">
                            <div class="col-3" style="width: auto;"><label class="col-form-label" style="margin-left: 10%;">Date fin</label></div>
                            <div class="col-4"><input class="form-control" type="datetime-local" name="date_fin" required=""></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col-3" style="width: auto;"><label class="col-form-label" style="margin-left: 10%;">Description de l'évènement</label></div>
                            <div class="col-7">
